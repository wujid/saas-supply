          ...
          <el-row class="row-item">
            ...
            <el-col :span="8">
              <el-form-item label="租户编码：" prop="tenant.code">
                <el-input v-model="form.tenant.code" class="form-width" placeholder="请输入租户编码" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-row class="row-item">
            <el-col :span="8">
              <el-form-item label="授权天数：" prop="tenant.days">
                <el-input-number v-model="form.tenant.days" :precision="0" class="form-width" size="medium" :min="1" placeholder="请输入授权天数" />
              </el-form-item>
            </el-col>
          </el-row>
        </div>
          ...
          <el-row class="row-item">
            <el-col :span="8">
              <el-form-item label="机构编码：" prop="org.code">
                <el-input v-model="form.org.code" class="form-width" placeholder="请输入机构名称" />
              </el-form-item>
            </el-col>
            <el-col :span="8">
...
import { addTenant, getResourceTree } from '@/api/system'
...
export default {
  ...
  data() {
    ...
    return {
      form: {
        ...
        resourceIdList: [],
        roleList: [{ id: null, code: 'system', name: '系统', description: '', isSystem: true, status: 0 }]
      },
      rules: {
        ...
        'user.password': [{ required: true, message: '请输入管理员密码' }, { validator: checkPassword }],
  ...
  async created() {
    ...
    this.resourceData.dataList = data
